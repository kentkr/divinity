...
os.environ['APCA_API_KEY_ID'] = 'PKZ8UJHM6IRLYWQQVCQJ'
os.environ['APCA_API_SECRET_KEY'] = 'B3Dytdnj8wLleBKYaBKhqHSZz54xWCv2E1V5NMRY'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--date', type=str, default='2021-01-01', help='date you want to get data for')
